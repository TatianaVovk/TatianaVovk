...
- **TDU (Industrial ML)**
  ...
  - Репозиторий отражает инженерные и ML-решения, доработанные и применённые позже в коммерческой реализации проекта

https://github.com/TatianaVovk/TDU 
...
https://github.com/TatianaVovk/rag_qa_project 
...
https://github.com/TatianaVovk/llm-cv-vacancy-scoring-mvp 
...
https://github.com/TatianaVovk/ai-avatar-stream-mvp 
